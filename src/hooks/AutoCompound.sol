...
// import {CurrencyDelta} from "lib/v4-core/src/libraries/CurrencyDelta.sol";
...
// import {BalanceDeltaLibrary, BalanceDelta, toBalanceDelta} from "lib/v4-core/src/types/BalanceDelta.sol";
...
//         int24 tickUpper,
//         bytes32 salt
//     ) public view returns (int256 liquidity) {
//         uint128 totalLiquidity = poolManager
//             .getPosition(key.toId(), address(this), tickLower, tickUpper, 0)
//             .liquidity;
...
//             liquidity = ((userShares[id] /
//                 totalShares[getPoolId(key.toId(), tickLower, tickUpper)]) *
//                 totalLiquidity.toInt256());
//         }
//     }
...
//         int256 userLiq = getUserLiquidity(
//             msg.sender,
//             key,
//             params.tickLower,
//             params.tickUpper,
...
//         totalShares[
//             getPoolId(key.toId(), params.tickLower, params.tickUpper)
...
//         (state.usefee0, state.usefee1) = LiquidityAmounts
...
//         uint256 feeDelta0 = uint256(int256(state.earnedFeeDelta.amount0())) -
//             state.usefee0;
//         uint256 feeDelta1 = uint256(int256(state.earnedFeeDelta.amount1())) -
//             state.usefee1;
...
//         state.userDelta =
//             state.liquidityDelta +
//             toBalanceDelta(state.usefee0.toInt128(), state.usefee1.toInt128());
...
//         PoolKey memory key,
//         HookData memory params
//     ) internal {
//         SwapAutoCompoundState memory state;
//         int24 currentTick;
//         (state.sqrtPriceX96, currentTick, , ) = poolManager.getSlot0(
//             key.toId()
//         );
...
//         uint256 priceX96 = (uint256(params.sqrtPriceX96) *
//             uint256(params.sqrtPriceX96)) / Q96;
...
//                 state.sell0 = false;
//             } else {
//                 state.amountRatioX96 =
//                     (state.positionAmount0 * Q96) /
//                     state.positionAmount1;
//                 state.sell0 = (state.amountRatioX96 * amount1 < amount0 * Q96);
//                 if (state.sell0) {
//                     state.delta0 =
//                         ((amount0 * Q96) - (state.amountRatioX96 * amount1)) /
//                         (((state.amountRatioX96 * priceX96) / Q96) + Q96);
//                 } else {
//                     state.delta0 =
//                         ((state.amountRatioX96 * amount1) - (amount0 * Q96)) /
//                         (((state.amountRatioX96 * priceX96) / Q96) + Q96);
//                 }
//             }
